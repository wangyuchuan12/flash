...
import net.zhigang.dante.util.ValidateUtil;
import net.zhigang.dante.domain.Admin;
import net.zhigang.dante.service.AdminService;
import net.zhigang.dante.util.DateFormatUtil;
...
@Controller
public class AdminController extends BaseController implements FactoryBean{
     ...
     * 
     * @param realname
     *            ,id,username,mobile,password,m.
     * @author ZhangLei.
     * @serialData 2014年12月25日
     * @return url
     */
    ...
    /**
     * @function this method is used to link the page off add_admin.jsp
     * @param m
     *            (modelview)
     * @author ZhangLei
     * @serialData 2014年12月25日
    ...
    /**
     * @function reset the password of admin
     * @param username
     *            ,m
     * @author ZhangLei
     * @serialData 2014年12月25日
